...
<body>
    ...
    <!-- jquery vendor -->
    <script src="{{ url('public/js/lib/jquery.min.js')}}"></script>
    <script src="{{ url('public/js/lib/jquery.nanoscroller.min.js')}}"></script>
    <!-- nano scroller -->
    <script src="{{ url('public/js/lib/menubar/sidebar.js')}}"></script>
    <script src="{{ url('public/js/lib/preloader/pace.min.js')}}"></script>
    <!-- sidebar -->

    <script src="{{ url('public/js/lib/bootstrap.min.js')}}"></script>
    ...
    <script src="{{ url('public/js/lib/weather/jquery.simpleWeather.min.js')}}"></script>
    <script src="{{ url('public/js/lib/weather/weather-init.js')}}"></script>
    <script src="{{ url('public/js/lib/circle-progress/circle-progress.min.js')}}"></script>
    <script src="{{ url('public/js/lib/circle-progress/circle-progress-init.js')}}"></script>
    <script src="{{ url('public/js/lib/chartist/chartist.min.js')}}"></script>
    <script src="{{ url('public/js/lib/sparklinechart/jquery.sparkline.min.js')}}"></script>
    <script src="{{ url('public/js/lib/sparklinechart/sparkline.init.js')}}"></script>
    ...
    <!-- scripit init-->
    <script src="{{ url('public/js/dashboard2.js')}}"></script>
</body>
